...
-- For the For statement, INP first evaluates the value of the variable that represents the number of iterations of the program that will be execute, 
...
-- then INP leaves the program only parsed and not evaluated.
      ...
      case ys of
        ...
        ":help" ->
          do
            ...
            putStrLn  ""
            putStrLn  "  :syntax        prints the INP formal grammar"
            putStrLn  ""
            putStrLn  "  :help          prints the help with the commands of the program"
            putStrLn  ""
            putStrLn  "  :quit          stops the INP program"
            putStrLn  ""
            parser xs
...
inp = do
            ...
            putStrLn ""
            putStrLn ""
            putStrLn "-+-+-+-+-+- INP Language Interpreter -+-+-+-+-+-"
		putStrLN "         developed by Alessio Pagliarulo         "
            putStrLn ""
